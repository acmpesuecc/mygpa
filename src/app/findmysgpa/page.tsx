...
export const metadata: Metadata = {
    ...
    description:
        "Calculate your Semester Grade Point Average (SGPA) for PES University. Enter your current semester grades and credits to get your accurate SGPA instantly.",
